...
#Prepare length_distrib results
...
res_agg_pc = pd.read_table('results/aggregation/gene_biotype/protein_coding/results', index_col=0)
res_agg_linc = pd.read_table('results/aggregation/gene_biotype/lincRNA/results', index_col=0)
...
f, (ax1, ax2, ax3) = plt.subplots(1,3,figsize=(25, 5), sharey=True, gridspec_kw={"wspace":0.05, "width_ratios":[0.5,1,2]})
