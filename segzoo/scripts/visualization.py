...
# TODO un-hardcode the path of the files
res_agg_pc = pd.read_table('outdir/results/aggregation/gene_biotype/protein_coding/results', index_col=0)
res_agg_linc = pd.read_table('outdir/results/aggregation/gene_biotype/lincRNA/results', index_col=0)
